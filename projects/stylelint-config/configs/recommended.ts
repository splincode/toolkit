...
import noMaskShorthand from '../rules/no-mask-shorthand';
import noWebkitBoxOrientBlockAxis from '../rules/no-webkit-box-orient-block-axis';
import relativeLessImportExtension from '../rules/relative-less-import-extension';
...
const config: StylelintConfig = {
    ...
    plugins: [
        noMaskShorthand,
        noWebkitBoxOrientBlockAxis,
        relativeLessImportExtension,
        'stylelint-order',
